package com.provence.controller.cover;
...
//		if(host != null && (host.contains("aimebio.com")||host.contains("prodepro.com"))){
//			return "cover-construction";
//		}
...
//		}
    ...
    private static String[] MOBILE_USER_AGENT=new String[]{
