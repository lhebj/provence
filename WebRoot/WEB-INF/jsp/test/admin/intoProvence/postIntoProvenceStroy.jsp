...
<body>
	...
	<FORM class="form-horizontal" name="form1" METHOD="POST"
		ACTION="intoProvenceAdmin.do?action=saveStory">
		<input name="id" type="hidden" value="${intoProvenceStoryDto.idInps}" />
		<input name="typeInps" type="hidden" value="${type}" />
		<table>
			<tr>
				<td><textarea id="wysiwyg" style="width:900px;height:600px"
						name="storyInps">${intoProvenceStoryDto.storyInps}</textarea></td>
				</td>
			</tr>
			<tr>
